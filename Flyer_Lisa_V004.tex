...
\vspace*{20mm}
\begin{figure}[h]
 \includegraphics [scale=.25]{Eik1.jpg}
...
%includegraphics[angle=270, scale=.35]{Eik1.jpg}
...
\vspace*{4mm}
Wie kan es jetzt noch besser werden? \\
\vspace*{4mm}
...
\vspace*{4mm}
"Wenn Du etwas in deinme Leben ändern möchtest, erwarte nicht, dass diese Veränderung im Außen beginnt."\\
\end{flushleft}
